    ...
    return (
        <>
            ...
            <div className='container min-vh-100'>
                ...
                whileInView={{ opacity: 1 }}  
                transition={{ duration: 1 }}  
                className='d-flex flex-column align-items-center justify-content-center gap-3 p-5 rounded borde-azul'>
                    ...
                    <div class="row g-2 w-100">
                        <div class="col-6">
                            <img src={IndexPNG} alt="" className='img-fluid w-100'/>
                        </div>
                        <div class="col-6">
                            <img src={RecordatoriosPNG} alt="" className='img-fluid w-100'/>
                        </div>
                    </div>
                </motion.div>
            </div>
            <div className='min-vh-100 d-flex flex-column align-items-center justify-content-around'>
                <div className="pattern w-100" style={{height: '50px'}}></div>
                <div className='container'>
                    ...
                    className='d-flex flex-column align-items-center justify-content-center gap-5 py-5'>
                        <h1 className='m-0 mt-2 fw-bold txt-rosa-oscuro'>Tecnologías</h1>
