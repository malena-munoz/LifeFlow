...
// ▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬
export async function ReporteOpcion3(id) {
    ...
    try {
        const response = await fetch(`https://localhost:7245/api/reporte/opcion-3`, opciones);
...
// ▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬
export async function ExcelOpcion3(id, nombre) {
    ...
    try {
        const response = await fetch(`https://localhost:7245/api/reporte/excel-opcion-3/${id}`, opciones);
        ...
        const link = document.createElement("a");
        link.href = URL.createObjectURL(blob);
        link.download =  `Excel_Opcion3 - ${nombre} (${new Date().toISOString().split('T')[0]}).xlsx`;
        document.body.appendChild(link);
        link.click();
        document.body.removeChild(link);
